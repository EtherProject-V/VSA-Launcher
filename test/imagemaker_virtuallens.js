...
function createImageWithMetadata() {
    ...
    // 2. Define Metadata for VirtualLens2
    const metadata = {
        "VSACheck": "true",
        ...
        "Integral_BokehShape": "",
        "IsVirtualLens2": "true",
        "VirtualLens2_Aperture": "8.0",
        "VirtualLens2_FocalLength": "35",
        "VirtualLens2_Exposure": "-0.5",
        "Description": "VirtualLens2で撮影されたテスト画像です。"
    };
    ...
    // 5. Write to file
    const outputPath = 'virtuallens_test_image.png';
