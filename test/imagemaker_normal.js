...
function createImageWithMetadata() {
    ...
    // 2. Define Metadata for a normal photo
    const metadata = {
        "VSACheck": "true",
        "WorldName": "ノーマル・テストワールド",
        "WorldID": "wrld_normal_test_world_id",
        "Capture-User": "Normal-User", // example.jsonの形式に合わせて変更
        "CaptureTime": new Date().toISOString(),
        "instans-Usernames": "Normal-Friend1, Normal-Friend2", // example.jsonの形式に合わせて変更
        "IsIntegral": "false",
        "Integral_Aperture": "0.0",
        "Integral_FocalLength": "0",
        "Integral_Exposure": "0.0",
        "Integral_ShutterSpeed": "0",
        "Integral_BokehShape": "",
        "IsVirtualLens2": "false",
        "VirtualLens2_Aperture": "0.0",
        "VirtualLens2_FocalLength": "0",
        "VirtualLens2_Exposure": "0.0",
        "Description": "通常カメラで撮影されたテスト画像です。"
    };
    ...
    // 5. Write to file
    const outputPath = 'normal_test_image.png';
